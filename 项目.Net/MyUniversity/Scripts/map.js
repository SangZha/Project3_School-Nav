...
/* 生成地图导航区的图片 */	
	function buildPictures(){
		/* 给导航区图片的img标签赋值来生成图片 */
			$('.pictures-current').children('.pictures-img-label').attr('src','assets/img/1-1500500.jpg');
			$('.pictures-up').children('.pictures-img-label').attr('src','assets/img/1-1501500.jpg');
			$('.pictures-right').children('.pictures-img-label').attr('src','assets/img/1-1500501.jpg');
			$('.pictures-bottom').children('.pictures-img-label').attr('src','assets/img/1-1499500.jpg');
			$('.pictures-left').children('.pictures-img-label').attr('src','assets/img/1-1500499.jpg');
...
/* 更换地图导航区的的图片的data的id */
	function changePictures(skip_direction,change_id){
		...
		setTimeout(function(){
			$('.pictures-current').children('.pictures-img-label').attr('src','assets/img/1-'+ change_id +'.jpg');
			$('.pictures-up').children('.pictures-img-label').attr('src','assets/img/1-'+ up_id +'.jpg')
			$('.pictures-right').children('.pictures-img-label').attr('src','assets/img/1-'+ right_id +'.jpg')
			$('.pictures-bottom').children('.pictures-img-label').attr('src','assets/img/1-'+ bottom_id +'.jpg')
			$('.pictures-left').children('.pictures-img-label').attr('src','assets/img/1-'+ left_id +'.jpg')
		},500); 
	}
