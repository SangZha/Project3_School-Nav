...
(function ($) {
    ...
    function awdContentSlider() {
        ...
        menu_elem.on('click', function (e) {
			...
			if(goToSlide == 'map'){
				$('.awd-site-logo').removeClass('logo-black').addClass('logo-white');
			}
			else{
				$('.awd-site-logo').removeClass('logo-white').addClass('logo-black');
			}
            ...
            if (!elem.hasClass('active')) {
                ...
                elem.attr('href',''+goToSlide+'.html');

                slide_timeout = setTimeout(function () {
                    var goToSlideContent = $('.slide-' + goToSlide + '');
                    if (goToSlideContent) {
                        $('.slide-comment,.slide-map,.slide-login').removeClass('active');
